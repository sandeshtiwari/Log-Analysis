...
c.execute("select totalCount.date, totalCount.count as total, errorCount.count as errors from totalCount join errorCount on errorCount.date = totalCount.date")
rows = c.fetchall()
